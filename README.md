...
broadband networks that can be used to generate maps for understanding Internet resilience.
...
The objective is to find maps that are out there that are not yet known. In some countries regulators _may_ have these maps, but usually it is the Internet Service Providers (ISPs) / network operators who may have these maps. Often, they just simply are not posted online.
* Find broadband map
...
* Documentation currently in this repo:
    * Raise issues
    * Open a PR
